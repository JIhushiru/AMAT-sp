  ...
  if (!plots || plots.length === 0) {
    return (
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Model Results</h2>
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-gray-600 dark:text-gray-400">
        ...
        and Boruta + VIF feature selection: <strong className="text-gray-800 dark:text-gray-200">Cubist, GBM, MARS, RF, SVM, XGBoost</strong>.
      </p>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        {[
          ...
          <div key={m.name} className="bg-white dark:bg-gray-800 rounded-lg shadow p-3">
            <h4 className="font-semibold text-emerald-700 dark:text-emerald-400">{m.name}</h4>
            <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">{m.desc}</p>
          </div>
        ))}
      </div>
      ...
      {/* Plots */}
      {plots.map((plot) => (
        <div key={plot.name} className="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
          <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-1">{plot.label}</h3>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
        <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-3">Methodology</h3>
        <div className="grid md:grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-400">
          <div>
            <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-1">Feature Selection</h4>
          ...
          <div>
            <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-1">Cross-Validation</h4>
            <ul className="list-disc ml-5 space-y-1">

...
# SSP2-4.5
ax.plot(ssp245_trend.index, ssp245_trend.values, 's--', color='#3498db', linewidth=2,
        markersize=5, label='SSP2-4.5 (Moderate)', zorder=4)
if has_pi_245:
    ax.fill_between(ssp245_trend.index, ssp245_lower.values, ssp245_upper.values,
                     alpha=0.15, color='#3498db')

# SSP5-8.5
ax.plot(ssp585_trend.index, ssp585_trend.values, 'D--', color='#e74c3c', linewidth=2,
        markersize=5, label='SSP5-8.5 (High Emissions)', zorder=4)
if has_pi_585:
...
ax.set_title('National Banana Yield Trend (2010-2024 + SSP Projections 2025-2034)', fontsize=14)

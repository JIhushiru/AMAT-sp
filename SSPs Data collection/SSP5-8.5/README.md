...
"Fossil-fueled development" scenario - CO2 emissions continue to rise throughout the 21st century.
...
| Script | Input | Output |
|--------|-------|--------|
| `gee_to_gdrive.py` | GEE (NASA/GDDP-CMIP6, GFDL-ESM4, ssp585) | `gfdl_pr_2025_2034_monthly.tif`, `gfdl_tas_2025_2034_monthly.tif` on Google Drive |
